...
- Source changes require appropriate build and regression checks; packaging changes require package checks. `scripts/Check-Repository.ps1` must pass before a commit.
