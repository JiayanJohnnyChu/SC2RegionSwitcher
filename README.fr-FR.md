...
**Téléchargements :** [v3.5.3-preview.1](https://github.com/JiayanJohnnyChu/SC2RegionSwitcher/releases/tag/v3.5.3-preview.1) · [Toutes les versions](https://github.com/JiayanJohnnyChu/SC2RegionSwitcher/releases)
...
L'application prend en charge onze langues d'interface et le choix d'une langue de jeu internationale déjà installée.

![SC2 Region Switcher avec une configuration simulée](assets/screenshots/sc2-switcher-3.5.1.png)
...
1. Les deux installations du jeu sont terminées dans Battle.net et occupent des dossiers distincts, par exemple `D:\Games\StarCraft II CN` et `D:\Games\StarCraft II Global`. La Chine nécessite les textes et les voix en chinois simplifié ; l'installation internationale nécessite les deux ressources dans la langue choisie.
