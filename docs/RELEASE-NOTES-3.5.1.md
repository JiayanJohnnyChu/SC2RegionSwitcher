[简体中文](RELEASE-NOTES-3.5.1.zh-CN.md)

# SC2 Region Switcher 3.5.1 preview
...
- The responsive interface keeps settings, error details and actions accessible in small windows.
