[简体中文](RELEASE-NOTES-3.5.3.zh-CN.md)

# SC2 Region Switcher 3.5.3 preview
...
- The responsive interface keeps settings, error details and actions accessible in small windows. Settings content aligns with the footer controls, and text fields and language selectors share consistent internal spacing.
