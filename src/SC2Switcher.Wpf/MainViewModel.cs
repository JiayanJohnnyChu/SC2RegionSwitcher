...
public sealed class MainViewModel : INotifyPropertyChanged {
    ...
    public string StatusColor { get; private set; }="#2855DC";
    public string StatusBackground { get; private set; }="#EFF3FF";
    ...
    public string StepOneColor=>"#2855DC";
    public string StepTwoColor=>stage>=2?"#2855DC":"#E4E9F2";
    public string StepThreeColor=>stage>=3?"#2855DC":"#E4E9F2";
    ...
    public void SetCurrent(string value){currentRegion=value switch {"CN"=>"国服 · 中国", "EU"=>"外服 · 欧洲", "US"=>"外服 · 美洲", "KR"=>"外服 · 亚洲", _=>"暂未识别"};Refresh();}
    ...
    public void Status(string title,string detail,string tone="ready"){
        ...
        StatusColor=tone=="error"?"#975019":tone=="working"?"#2855DC":"#247456";
        StatusBackground=tone=="error"?"#FFF2E7":tone=="working"?"#EFF3FF":"#EAF5EF";
