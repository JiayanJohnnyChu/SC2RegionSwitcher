...
`_Validation.idt` contains standard column constraints for the fifteen tables used by this package builder. It was exported from a control package generated with WiX 3.14.1.8722 and filtered to those tables. It contains no application identity, local paths, payload or test-user data.
